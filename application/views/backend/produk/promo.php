    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">Data Promo</h3>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title" id="myModalLabel34">Tambah Promo</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="<?php echo base_url()?>BackendC/save_promo" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Produk: </label>
                                        <select class="form-control" name="produk_kode">
                                            <?php foreach ($produk as $j ) : ?>
                                                <option value="<?php echo $j['produk_kode']; ?>"><?php echo $j['produk_nama']; ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Diskon: </label>
                                        <input type="number" placeholder="Diskon (%)" name="promo_diskon" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
